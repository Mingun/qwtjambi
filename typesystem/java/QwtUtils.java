...
public abstract class QwtUtils {
    ...
    static QRectF qwtBoundingRect(QPointF sample) {
        return new QRectF(sample.x(), sample.y(), 0.0, 0.0);
    }
    static QRectF qwtBoundingRect(QwtPoint3D sample) {
        return new QRectF(sample.x(), sample.y(), 0.0, 0.0);
    }
    static QRectF qwtBoundingRect(QwtPointPolar sample) {
        return new QRectF(sample.azimuth(), sample.radius(), 0.0, 0.0);
    }
    static QRectF qwtBoundingRect(QwtIntervalSample sample) {
